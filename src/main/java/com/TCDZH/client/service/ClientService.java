...
public class ClientService {
  ...
  /**
   * TODO: Sends a request to the server to trigger an early start to the game
   */
  public void earlyStartGame(){
...
//    connectedGameId = gameId;
  ...
  public boolean playCard(Card card) {
    ...
    //The above add card function will put the card onto the pile and refresh the display
  }
}
